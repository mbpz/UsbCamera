...
//	private static final String TAG = "GLDrawer2D";
    ...
    public GLDrawer2D(final float[] vertices,
        ...
        mTexTarget = isOES ? ShaderConst.GL_TEXTURE_EXTERNAL_OES : ShaderConst.GL_TEXTURE_2D;
        ...
        if (isOES) {
            hProgram = GLHelper.loadShader(ShaderConst.VERTEX_SHADER, ShaderConst.FRAGMENT_SHADER_SIMPLE_OES);
        } else {
            hProgram = GLHelper.loadShader(ShaderConst.VERTEX_SHADER, ShaderConst.FRAGMENT_SHADER_SIMPLE);
        }
        // モデルビュー変換行列を初期化
